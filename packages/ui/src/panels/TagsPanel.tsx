  ...
  return (
    ...
    >
        ...
        {tagsByType.size === 0 ? (
          ...
          Array.from(tagsByType.entries()).map(([type, nodes]) => (
            <TagTypeItem
              ...
              onSelect={() =>
                setSelectedTag(type === selectedTag ? null : type)
              }
            />
          ))
        )}
      ...
      >
        ...
        >
          <span className={css({ color: theme.status.fulfilled })}>
            {"<"}\u2014
          </span>
        ...
        {!selectedTag ? (
          ...
          providers.map((provider) => (
            ...
            >
              ...
              <div
                className={css({ flex: 1, minWidth: 0, overflow: "hidden" })}
              >
      ...
      >
        ...
        >
          <span className={css({ color: theme.status.rejected })}>
            {"\u2014>"}
          </span>
